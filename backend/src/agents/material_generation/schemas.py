...
class MaterialCreationResponse(BaseModel):
    ...
    texture_asset_key: str | None = (
        None  # 텍스처 에셋 키 (materials/{material_id}/texture.png 형식)
    )
    thumbnail_asset_key: str | None = (
        None  # 썸네일 에셋 키 (materials/{material_id}/thumbnail.png 형식)
    )
