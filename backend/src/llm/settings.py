...
class LLMSettings:
    ...
    def from_env(cls, env: Mapping[str, str] | None = None) -> LLMSettings:
        ...
        return cls(
            ...
            timeout_ms=_int_from_env(source, "FACTORY_LLM_TIMEOUT_MS", 20000),
            max_output_tokens=_int_from_env(
                source,
                "FACTORY_LLM_MAX_OUTPUT_TOKENS",
                2048,
            ),
            temperature=_float_from_env(source, "FACTORY_LLM_TEMPERATURE", 0.2),
        )
